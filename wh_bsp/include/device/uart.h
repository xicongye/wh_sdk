...
*
***************************************************************************/
#ifndef SDJ2102_UART_H
#define SDJ2102_UART_H
#define HAS_WH_UART
...
void uart2_fflush(void); // fifo flush
void uart2_set_IE(char ena_mask); //set the interrupt enable with IE register mask
void uart2_reset_IE(char ena_mask);//set the interrupt disable with IE register mask
